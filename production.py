...
if uploaded_file is not None:
    ...
    if view == 'Territorial Manager':
        ...
        with card_container(key="chart1"):
            ...
            with cc_row2[0]:
            # can just use 'good', 'bad', 'neutral' sentiment to auto color the card
                hc.info_card(title='Yesterday Production', content= f'{fom_day_premium}', sentiment='good',bar_value=77, key='day_premium', content_text_size='large', title_text_size='small')
